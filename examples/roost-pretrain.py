...
def main(
    ...
    **kwargs,
    ...
    task_dict = {k: v for k, v in zip('SSL', tasks)}  ## Contains the tasks, for pretraining mention SSL
    loss_dict = {k: v for k, v in zip('SSL', losses)} ## Constains the dictionary for loss function, 
