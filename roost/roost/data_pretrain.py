...
class CompositionData(Dataset):
    ...
    def __init__(
        ...
        # self.magpie = np.load('./data/datasets/Pretrain_combined_magpie.npy',allow_pickle=True)

        # assert self.df.shape[0] == self.magpie.shape[0],'Composition and Magpie Feature does not match'
    ...
    def __getitem__(self, idx):
        ...
        # magpie_feature = self.magpie[idx].astype(np.float64)
...
def collate_batch(dataset_list):
    ...
    for i, (inputs_1, inputs_2,train_mask_1, train_mask_2,*cry_ids) in enumerate(dataset_list):
        ...
        #Magpie
        # magpie_feature_batch.append(magpie_feature)
    # print(len(magpie_feature_batch))
