...
from roost.core_pretrain_fl_mml import BaseModelClass
...
class Roost(BaseModelClass):
    ...
    the stoichiometry of iganic materials in a trainable manner.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.magpie_proj = nn.Linear(256,256)
    ...
    def forward(self, elem_weights, elem_fea, self_fea_idx, nbr_fea_idx, cry_elem_idx):
        ...
        proj_out = self.proj_nn(crys_fea)
        magpie_out = self.magpie_proj(proj_out)
