...
class BaseModelClass(nn.Module, ABC):
    ...
    def evaluate(
        ...
        for inputs_1, inputs_2, magpie_feature,*_ in tqdm(
            ...
            loss = criterion.forward(outputs_1, outputs_2)
            #print(loss)
            #print(metrics)
